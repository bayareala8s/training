#!/usr/bin/env python3
"""Render BayAreaLa8s AI Automation course — personas / career-outcomes marketing PNGs."""
...
OUT = ROOT / "docs" / "course-ai-automation-agents-bedrock-personas.png"
OUT_SQUARE = ROOT / "docs" / "course-ai-automation-agents-bedrock-personas-square.png"
...
PERSONAS = [
    (
        ...
        "Ship Bedrock into Lambda & Step Functions with start/stop cost control.",
        "Upskill for production AI delivery — stronger interview demos.",
    ),
    (
        "Platform / SRE",
        "Agents with allow-lists, audit trails, dashboards, and approval gates.",
        "Ready for promotion talks on AI ops reliability & governance.",
    ),
    (
        "Solutions Architect",
        "Reference architecture plus 4 capstones you can show clients.",
        "Win trust in client conversations with live AWS proof.",
    ),
    (
        "AI / ML Engineer",
        "Move from prompts to validated workflows, APIs, and agents.",
        "Bridge ML skills into enterprise automation roles.",
    ),
    (
        "Career Switcher / Student",
        "Portfolio projects: incident triage, docs, approvals, agents.",
        "Build hire-ready evidence employers recognize.",
    ),
    (
        "Engineering Manager",
        "Team patterns for guardrails, cost limits, and safe rollouts.",
        "Lead AI initiatives with ops-ready standards.",
    ),
]
...
def render_wide() -> Image.Image:
    ...
    draw.text(
        (160, 212),
        "Upskill for production AI roles — portfolio projects that support\n"
...
def render_square() -> Image.Image:
    ...
    draw.text((48, 118), "AI Automation & Agents with AWS Bedrock", font=subtitle, fill=WHITE)
    draw.rectangle((48, 148, 420, 154), fill=GOLD)
    draw.text(
        (48, 170),
        "Upskill for production AI roles — portfolio projects that\n"
