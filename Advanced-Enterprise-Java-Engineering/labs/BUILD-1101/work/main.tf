# BUILD-1101 work copy — AEJE-D-048 / ACCOUNT.md
# Starter left incomplete. This tree adds health_check + containerPort only.
# Region us-west-2. No NAT, EKS, RDS. No BAYPAY_DB_PASSWORD. No apply required.
