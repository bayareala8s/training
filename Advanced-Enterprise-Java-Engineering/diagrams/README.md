...
BayPay architecture and stack (not new catalog IDs): [java/baypay/README.md](java/baypay/README.md) — modular monolith, local vs student Fargate, create-payment path.
