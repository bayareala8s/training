# INC-JVM-801 — Canary CPU 98 percent

**Lab:** INCIDENT-801  
**Severity:** SEV-2  
**Service:** payment-service (`pay-prod-east-2`)  
**When:** 2026-10-06 10:18 Pacific (17:18 UTC)  
...
| JVM metrics | **Omitted** as a standalone file (CPU and thread counts appear on the dashboard) |
