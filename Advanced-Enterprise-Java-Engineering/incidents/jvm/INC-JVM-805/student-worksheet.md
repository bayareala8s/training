...
(File, timestamp, quote. Pause, allocation rate, histogram classes.)
...
(What restores customer latency *now*? Which config or instance do you touch? What do you explicitly not do?)
