...
The Boot teaching app is not a Liberty wave target. Do not schedule “cut `reference-apps/baypay` to Liberty” as wave 2. Running that JAR on ECS/EKS is a **different exit** — L-6.6.
