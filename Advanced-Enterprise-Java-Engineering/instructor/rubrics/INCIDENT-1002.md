...
| Dimension | 5 | 3 | 1 |
|---|---|---|---|
| Technical accuracy | 512Mi limit; `-Xmx512m` (100%); cgroup `OOMKilled` exit 137; last GC ~401/512 MB; not Java OOME first | OOMKilled named; Xmx vs limit mentioned; mechanism fuzzy | “Java heap leak” or “bounce Postgres” as RCA |
...
| Security / reliability | Availability during restart bursts; idempotent retries; right-size needs a flag review | Mentions 502s | Ignores Avery retries |
...
Stabilization that only says “restart the pod” without changing limit or heap pairing loses Production awareness. Copying INCIDENT-806’s 389 MB figure without this pack’s 401M scrap loses Technical accuracy.
