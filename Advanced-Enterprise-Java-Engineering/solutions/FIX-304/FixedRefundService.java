...
/**
 * FIX-304 reference fix. Ledger failures propagate so {@code @Transactional}
 * rolls back the refund row. Do not catch and return success.
 */
@Service
public class FixedRefundService {
